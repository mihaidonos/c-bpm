package org.camunda.example.camunda_template_example;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "camunda-template-example";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "camunda-template-example.war")
            ...
            .addPackages(false, "org.camunda.example.camunda_template_example") // not recursive to skip package 'nonarquillian'
