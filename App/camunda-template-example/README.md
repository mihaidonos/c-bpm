...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/camunda-template-example/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/camunda-template-example">Camunda BPM Process Application</a></td>
