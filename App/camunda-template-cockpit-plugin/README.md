...
[camunda-archetype-cockpit-plugin-7.4.0](http://docs.camunda.org/latest/guides/user-guide/#process-applications-maven-project-templates-archetypes).
...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/camunda-template-cockpit-plugin/screenshot.png" width="100"></td>
    <td><a href="snippets/camunda-template-cockpit-plugin">Camunda Cockpit Plugin</a></td>
