...
import org.camunda.example.cockpit.camunda_template_cockpit_plugin.db.ProcessInstanceCountDto;
...
public class ProcessInstanceResource extends AbstractCockpitPluginResource {
  ...
  public List<ProcessInstanceCountDto> getProcessInstanceCounts() {
    ...
    return getQueryService()
        .executeQuery(
          "org.camunda.example.cockpit.camunda_template_cockpit_plugin.selectProcessInstanceCountsByProcessDefinition",
